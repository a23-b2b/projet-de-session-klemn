            ...
            return (
                <div className={styles.label}>
                    ...
                    <div className={styles.paragraphe}>
                        ...
                        <div>
                            <p className={styles.p2} onClick={() => setFormIsLogin(false)}>Inscrivez vous!</p>
                        </div>
                    </div>
                </div>
            )
        ...
        return (
            <div className={styles.label}>
                ...
                <div className={styles.paragraphe}>
                    ...
                    <div>
                        <p className={styles.p1}>Vous êtes déjà inscrit?</p>
                    </div>
                    <div>
                        <p className={styles.p2} onClick={() => setFormIsLogin(true)}>Connectez vous!</p>
