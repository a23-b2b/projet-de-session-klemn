...
VALUES
  ('id_projet_1', 'Titre de projet collaboratif', 'Marie veut collaborer avec Louis sur le projet ID: id_projet_1', 'https://github.com/a23-b2b/projet-de-session-klemn', true, 'yjoI2WF3w4WVr3kD9L01shSjjnL2');
