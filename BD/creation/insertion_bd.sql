...
VALUES 
  (
    'id_1', '2023-08-30 10:00:00', 'Dubois', 
  ...
  (
    'id_2', '2023-08-30 11:30:00', 'Tremblay', 
  ...
  (
    'id_3', '2023-08-30 14:45:00', 'Lévesque', 
...
INSERT INTO post_question (
  id_question, est_resolu, post_meilleure_reponse, 
  post_id_post
) 
VALUES 
  (
...
VALUES 
  (
    '610ef2fce0a0', true, 'https://github.com/', 
    'post_collab_id_3'
  );
COMMIT;
...
VALUES 
  (
    'post_collab_id', 'yjoI2WF3w4WVr3kD9L01shSjjnL2', 
    1, "Titre de Blogue", "Contenu de Blogue", 
    0, 0, 0, 0, 0, NOW()
  );
INSERT INTO post_collab (
...
VALUES 
  (
    'id_collab', true, 'https://github.com/', 
    'post_collab_id'
  );
INSERT INTO demande_collab (
  id_demande_collab, est_accepte, post_collab_id_collab, 
  id_collaborateur
) 
VALUES 
  (
    "id_demande", false, "id_collab", 
