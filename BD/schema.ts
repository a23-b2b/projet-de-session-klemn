...
export const post = mysqlTable("post", {
    ...
    content: varchar("contenu", { length: 255 }),
...
export const user = mysqlTable("compte", {
    ...
    phone: varchar("prenom", { length: 20 }),
...
export const collaborationRequest = mysqlTable("demande_collab", {
    ...
    collaborationId: varchar("post_collab_id_collab", { length: 255 }).references(() => collaboration.id),
...
export const question = mysqlTable("post_question", {
    ...
    answer: varchar("post_meilleure_reponse", { length: 255 }).references(() => post.id),
});
...
//     reposts: post.reposts,
//     shares: post.shares,
//     collabProjectUrl: collaboration.id
// })