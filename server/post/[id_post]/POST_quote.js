...
module.exports = app.post('/:id_post/quote', [body('contenu').notEmpty().isLength({ max: 4000 })], (req, res) => {
    const resultatValidation = validationResult(req);
    if (resultatValidation.isEmpty()) {

        const contenu = req.body.contenu;
        const quotedPostId = req.params.id_post;
        ...
        admin.auth().verifyIdToken(idToken, true).then((payload) => {
            ...
            pool.query(
                `INSERT INTO post 
                    ...
                    order by date_publication desc
                    limit 1;`,
                [userId, contenu, userId, quotedPostId, userId],
